...
| NFR-4 Simplicity | US-12, US-24, US-25, US-26 | #12, #74 | **Yes**: one screen, primary task on the landing page, plain-language errors, **one file picker** for the application and the photographs alike (FR-12), and after an upload has been read, a line per value that was found and a field only for the ones that were not (FR-13) | **Yes**: `a11y.spec.ts`, `liveRegion.test.tsx`, `applicationFirst.test.tsx`, `oneUpload.test.tsx`, `quietFields.test.tsx` |
| NFR-5 Accessibility | US-13, US-24, US-25, US-26 | #13, #74 | **Yes**: labelled inputs, keyboard reachable, visible focus, verified contrast, live regions; each accepted file announced with what it was taken to be (FR-12), and a missing value focused, scrolled to and announced (FR-13) | **Yes**: axe-core against the built page in CI, collapsed and expanded and over the file list, plus `contrast.test.ts`, a keyboard walk, `applicationFirst.test.tsx` and `quietFields.test.tsx` |
