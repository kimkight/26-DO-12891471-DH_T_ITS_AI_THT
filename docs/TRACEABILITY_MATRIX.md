...
| 9 | Sample label: "45% Alc./Vol. (90 Proof)", "750 mL" | Technical Requirements | FR-7 | US-6 | [#6](https://github.com/kimkight/26-DO-12891471-DH_T_ITS_AI_THT/issues/6) | Not written; UAT rows 7, 8 | |
...
| FR-7 Numeric comparison | US-6 | #6 | No | No |
...
| NFR-10 GovCloud portability | US-19 | #19 | No: no infrastructure code exists | No |
...
| --- | --- |
| OQ-4 numeric tolerance | FR-7, US-6 |
| OQ-5 unit conversion | FR-7, US-6 |
